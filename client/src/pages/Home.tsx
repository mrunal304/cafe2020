  ...
  return (
    <CustomerLayout>
      <div className="relative z-10">
        ...
        <div className="bg-[#c8c8c8f2] p-6 rounded-2xl shadow-xl border border-white/20">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-white/90 border-stone-200 focus:ring-orange-500 focus:border-orange-500 h-12 text-lg rounded-xl"
                />
                {form.formState.errors.name && (
                  <p className="text-red-600 text-xs font-medium">{form.formState.errors.name.message}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-white/90 border-stone-200 focus:ring-orange-500 focus:border-orange-500 h-12 text-lg rounded-xl tracking-wider"
                  maxLength={10}
                  onChange={(e) => {
                ...
                {form.formState.errors.phoneNumber && (
                  <p className="text-red-600 text-xs font-medium">{form.formState.errors.phoneNumber.message}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                    ...
                    <button
                      ...
                      className={`
                        ...
                        ${form.watch("numberOfPeople") === num 
                          ...
                          : "bg-white/90 text-stone-500 hover:bg-stone-200"}
                      `}
                    >
                      {num}
                    </button>
                ...
                <Input
                  ...
                  className="
                    ...
                    bg-white/90 text-stone-900 text-lg
                ...
                {form.formState.errors.numberOfPeople && (
                  <p className="text-red-600 text-xs font-medium">{form.formState.errors.numberOfPeople.message}</p>
                )}
              </div>
            </div>
